...
- Copy and paste the file `main.py` and the model in joblib format in the new repository. Then, you can commit your changes in GitHub Desktop with a _commit message_ in the bottom left form (for instance `First commit`).
...
- Your local repository `Documents/GitHub/yourwineapi` should contain the following files: 
...
- Your local repository `Documents/GitHub/yourwineapi` should containg the following files: 
...
- Open GitHub Desktop and in your local repository `Documents/GitHub/yourwineapi`, you will find the option to Publish the repository to GitHub. Click on the button and follow the instructions.
...
- Go back to your GitHub repository. You will see that Azure created a new repository `.github/workflows` containing a yml file:
